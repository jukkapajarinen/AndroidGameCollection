  ...
  private void setOnClickListeners() {
    ...
    mSettingsFAB.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View view) {
        ...
        settingsDialog.show();
        settingsDialog.getButton(AlertDialog.BUTTON_POSITIVE).setTextColor(0xff209cee);
        settingsDialog.getButton(AlertDialog.BUTTON_NEGATIVE).setTextColor(0xff209cee);
        settingsDialog.getButton(AlertDialog.BUTTON_NEUTRAL).setTextColor(0xff209cee);
      }
    });
