  ...
  private void setOnClickListeners() {
    ...
    mSettingsFAB.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View view) {
        ...
        settingsDialog.show();
        settingsDialog.getButton(AlertDialog.BUTTON_POSITIVE).setTextColor(0xffc60c30);
        settingsDialog.getButton(AlertDialog.BUTTON_NEGATIVE).setTextColor(0xffc60c30);
        settingsDialog.getButton(AlertDialog.BUTTON_NEUTRAL).setTextColor(0xffc60c30);
      }
    });
