...
public class SettingsDialog extends AlertDialog {
  ...
  private final Spinner mDifficultySpinner;
  private final Spinner mTotalHintsSpinner;
  ...
  protected SettingsDialog(final Context context) {
    ...
    mDifficultySpinner = (Spinner) dialogLayout.findViewById(R.id.difficultySpinner);
    mTotalHintsSpinner = (Spinner) dialogLayout.findViewById(R.id.totalHintsSpinner);
    ...
    mDifficultySpinner.setSelection(mPrefs.getInt("prefDifficultyChoice", 0));
    mTotalHintsSpinner.setSelection(mPrefs.getInt("prefTotalHintsChoice", 1));
    ...
    setButton(AlertDialog.BUTTON_POSITIVE, context.getResources().getText(R.string.dia_btn_save), new OnClickListener() {
      ...
      public void onClick(DialogInterface dialog, int which) {
        ...
        mEditor.putInt("prefDifficultyChoice", mDifficultySpinner.getSelectedItemPosition());
        mEditor.putInt("prefTotalHintsChoice", mTotalHintsSpinner.getSelectedItemPosition());
