...
public class MainActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
      ...
      getWindow().setStatusBarColor(0xfffe3e85);
    }
  ...
  private void setOnClickListeners() {
    ...
    mSettingsFAB.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View view) {
        ...
        settingsDialog.show();
        settingsDialog.getButton(AlertDialog.BUTTON_POSITIVE).setTextColor(0xfffe3e85);
        settingsDialog.getButton(AlertDialog.BUTTON_NEGATIVE).setTextColor(0xfffe3e85);
        settingsDialog.getButton(AlertDialog.BUTTON_NEUTRAL).setTextColor(0xfffe3e85);
      }
    });
