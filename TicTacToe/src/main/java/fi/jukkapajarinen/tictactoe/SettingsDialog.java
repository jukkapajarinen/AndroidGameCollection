...
public class SettingsDialog extends AlertDialog {
  ...
  protected SettingsDialog(final Context context) {
    ...
    mPlayerModeSpinner = (Spinner) dialogLayout.findViewById(R.id.playerModeSpinner);
    ...
    mPlayerModeSpinner.setSelection(mPrefs.getInt("prefPlayerModeChoice", 1));
    mMovesCheckBox.setChecked(mPrefs.getBoolean("prefMovesEnabled", false));
